...
public class CredentialEntry extends Entry {
    ...
    public CredentialEntry(String title, String site, String username, String plainPassword, EntryType type) throws InvalidEntryException {
        super(title, type);
        setSite(site);
    ...
    public void setSite(String site) {
        if (site == null || site.isEmpty()) throw new IllegalArgumentException("site cannot be null or empty");
        this.site = site;
    }
    ...
    public String getDecryptedSecret(SecretKey masterKey) throws CryptoException {
        try { return CryptoUtils.decrypt(this.encryptedSecret, masterKey); }
        catch (Exception e) { throw new CryptoException("Error decrypting secret: " + e.getMessage()); }
    }
